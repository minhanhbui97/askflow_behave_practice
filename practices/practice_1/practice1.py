...
print(str(session_list.get(4)))




# print("Original: I completed 2 sessions and I rated my expert five stars")
# print("After conversion: I completed %s" % str(num_to_word.get(2)) + " sessions and I rated my expert %s" %str(list(num_to_word.keys())[4]) + " stars")
